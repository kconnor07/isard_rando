...
interface Draft {
  ...
  decor:
    | 'orbes' | 'verre' | 'liquide' | 'lames' | 'rideau' | 'lamelles' | 'projecteur'
    | 'halo' | 'degrade' | 'points' | 'anneaux' | 'arcs' | 'disques' | 'colonne' | 'anneaux-larges'
...
const RECIPES: StartPoint[] = [
  {
    id: 'lames-bleues',
    label: 'Lames Bleues',
    hint: 'Grandes lames de verre bleu électrique à bord incandescent sur noir profond — le texte s’écrit dans le couloir sombre',
    swatch: 'linear-gradient(135deg,#01030a 20%,#0a48b4 62%,#9fd0ff 86%,#ffffff)',
    draft: {
      accent: '#1e7dff',
      secondary: '#8ec2ff',
      bg1: '#01030a',
  ...
  {
    id: 'lames-violettes',
    label: 'Lames Violettes',
    hint: 'Même matière de verre, violet électrique, lames ancrées en bas à gauche',
    swatch: 'linear-gradient(135deg,#050208 20%,#4c1d95 62%,#c4b5fd 86%,#ffffff)',
    draft: {
      accent: '#8b5cf6',
      secondary: '#c4b5fd',
      bg1: '#050208',
  ...
  {
    id: 'lames-emeraude',
    label: 'Lames Émeraude',
    hint: 'Verre vert d’eau sur noir, lames au centre : quatre coins de lumière autour du texte',
    swatch: 'linear-gradient(135deg,#00070a 20%,#065f52 62%,#99f6e4 86%,#ffffff)',
    draft: {
      accent: '#14b8a6',
      secondary: '#99f6e4',
      bg1: '#00070a',
  ...
  },
  {
    id: 'studio-mobile',
    label: 'Studio Mobile',
    hint: 'Violet profond, plis de lumière verticaux, grille technique et nœuds, titres fins très grands — l’esprit affiche produit',
    swatch: 'linear-gradient(150deg,#3b1d80,#1a0b3d 55%,#a78bfa)',
    draft: {
      accent: '#a78bfa',
      secondary: '#7c3aed',
      bg1: '#1a0b3d',
  ...
  },
  {
    id: 'affiche',
    label: 'Affiche',
    hint: 'Plis d’étoffe violets, titres très gras en capitales douces : l’accroche occupe toute la slide',
    swatch: 'linear-gradient(150deg,#2a0f5e,#160730 55%,#ede9fe)',
    draft: {
      accent: '#c4b5fd',
      secondary: '#8b5cf6',
      bg1: '#2a0f5e',
  ...
  },
  {
    id: 'cannele',
    label: 'Cannelé',
    hint: 'Verre cannelé : lamelles verticales traversées d’une nappe de lumière qui ondule',
    swatch: 'linear-gradient(90deg,#07030d,#a855f7 35%,#07030d 55%,#d8b4fe 78%,#07030d)',
    draft: {
      accent: '#a855f7',
      secondary: '#d8b4fe',
      bg1: '#07030d',
  ...
  },
  {
    id: 'projecteur',
    label: 'Projecteur',
    hint: 'Nappe de lumière venue du haut, chevrons de rythme, titres Playfair : la série de carrousel violette',
    swatch: 'linear-gradient(180deg,#8b5cf6,#12062b 62%,#07021a)',
    draft: {
      accent: '#8b5cf6',
      secondary: '#c4b5fd',
      bg1: '#12062b',
...
const DECOR_LABELS: Record<Draft['decor'], string> = {
  ...
  lames: 'Lames de verre : grandes courbes à bord incandescent sur noir',
  rideau: 'Rideau : plis de lumière verticaux, grille et nœuds',
  lamelles: 'Verre cannelé : lamelles verticales, nappe de lumière ondulante',
  projecteur: 'Projecteur : nappe venue du haut, chevrons de rythme',
  halo: 'Halo diffus',
  degrade: 'Dégradé',
